...
var OneBook3D = {
	...
	initWithData:function(FRDATA){
		...
		this.LNG = {
			save:['Save','РЎРѕС…СЂР°РЅРёС‚СЊ'],
			light:['Light','РЎРІРµС‚Р»С‹Р№'],
			dark:['Dark','РўРµРјРЅС‹Р№'],
			prev:['Prev','РќР°Р·Р°Рґ'],
			next:['Next','Р”Р°Р»РµРµ'],
			zoom:['Zoom','РњР°СЃС€С‚Р°Р±'],
			zoomclose:['Zoom','РњР°СЃС€С‚Р°Р±'],
			slope:['Slope','РќР°РєР»РѕРЅ'],
			fromfullscreen:['Smaller','РЈРјРµРЅСЊС€РёС‚СЊ'],
			tofullscreen:['Larger','РЈРІРµР»РёС‡РёС‚СЊ'],			
			close:['Close','Р—Р°РєСЂС‹С‚СЊ'],
			left:['Left','РЎР»РµРІР°'],
			right:['Right','РЎРїСЂР°РІР°'],
			toStart:['To start','Р’ РЅР°С‡Р°Р»Рѕ'],
			toEnd:['To end','Р’ РєРѕРЅРµС†'],

			hlpGoToHomelink:['Open homepage','РћС‚РєСЂС‹С‚СЊ РґРѕРјР°С€РЅСЋСЋ СЃС‚СЂР°РЅРёС†Сѓ'],
			hlpClickToOpen:['Click to open','РћС‚РєСЂРѕР№ РјРµРЅСЏ'],
			hlpUseMousewheel:['Use mouse wheel<br>for easy viewing','РСЃРїРѕР»СЊР·СѓР№С‚Рµ РєРѕР»РµСЃРѕ РјС‹С€Рё<br>РґР»СЏ Р»РёСЃС‚Р°РЅРёСЏ'],
			hlpUseMousewheelGL:[['Use mouse wheel','for easy viewing'],['РСЃРїРѕР»СЊР·СѓР№С‚Рµ РєРѕР»РµСЃРѕ','РјС‹С€Рё РґР»СЏ Р»РёСЃС‚Р°РЅРёСЏ']],
			askSaveImage:['Select the page to save, please','РљР°РєРѕРµ РёР·РѕР±СЂР°Р¶РµРЅРёРµ СЃРѕС…СЂР°РЅРёС‚СЊ?'],
			askSaveLinks:['<a href="#">Left</a> or <a href="#">Right</a>','<a href="#">Р›РµРІРѕРµ</a> РёР»Рё <a href="#">РџСЂР°РІРѕРµ</a>']
		};
